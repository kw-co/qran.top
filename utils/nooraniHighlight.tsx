...
export const isNooraniChar = (char: string): boolean => {
  if (!char) return false;
  return NOORANI_BASE_CHARS.has(char);
};
 ...
 */
export const splitIntoClusters = (word: string): LetterCluster[] => {
  ...
  while (i < word.length) {
    ...
    const isNoorani = isNooraniChar(char);
    let fullText = char;
    i++;
 ...
 */
export const isWordPureNoorani = (word: string): boolean => {
