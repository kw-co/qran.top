...
const WORD_AUDIO_KEY = 'qran_app_enable_word_audio_v2';
...
export const useSettings = () => {
    ...
    const [highlightHaMeem, setHighlightHaMeem] = useState<boolean>(
        () => safeGetItem(HIGHLIGHT_HA_MEEM_KEY, 'false') === 'true'
    );
