        ...
        <>
            ...
            <div className="qran-top-manual-body">
                <div className="qran-top-manual-container">
                    <header>
                        <h1>دليل استخدام تطبيق الباحث في المصحف الشريف</h1>
                    ...
                    <section id="general-idea">
                        ...
                        <p>
                            تطبيق <strong>الباحث في المصحف الشريف</strong> هو أداة متطورة صُممت لتسهيل تلاوة القرآن الكريم والبحث الدقيق فيه وتعميق تدبر آياته ومشاركة ختماته. يعتمد التطبيق على الدمج بين الدقة التقنية العالية وسهولة الاستخدام السلسة، مستخدماً نسختين معتمدتين:
                        </p>
                        <ul>
                            <li>
                                <div>
                        ...
                        <ul>
                            ...
                            <li>
                                ...
                                <div>
                                    ...
                                    <p className="feature-description">يشمل المصفوفة الأبجدية الشاملة لكامل القرآن مع شريط التقدم، وماسح الآيات النورانية والتحكم بحرف الواو، وماسح الحروف الأبجدية، والمصفوفة النورانية لاستخراج بصمة الكلمات في الفواتح المقطعة، وتحليل أزواج السور والفروق القرآنية.</p>
                                </div>
                            </li>
                            <li>
                    ...
                    <section id="disclaimer-and-sources">
                        ...
                        <div className="note" style={{marginTop: '1rem', background: 'var(--color-surface-subtle)'}}>
                            <div style={{display: 'flex', alignItems: 'center', gap: '0.5rem', marginBottom: '0.5rem'}}>
                                ...
                                <strong>الكود المصدري (مفتوح المصدر):</strong>
                            </div>
                            <p style={{margin: 0}}>
                                المشروع متوفر كبرنامج مفتوح المصدر على منصة GitHub:
                                <br />
                                <a href="https://github.com/kw-co/qran.top" target="_blank" rel="noopener noreferrer" style={{wordBreak: 'break-all'}}>https://github.com/kw-co/qran.top</a>
                            </p>
                        </div>
                    </section>
