            ...
            <main className="space-y-12">
                ...
                <section id="key-features">
                    ...
                    <ul className="grid grid-cols-1 md:grid-cols-2 gap-6">
                        ...
                        <FeatureItem icon={<BookmarkIcon className="w-6 h-6"/>} title="الدفتر والمحفوظات" description="احفظ الآيات المفضلة، ودوّن ملاحظاتك الشخصية، مع إمكانية التصدير والاستيراد بأمان." />
