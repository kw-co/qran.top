            ...
            <main className="space-y-12">
                ...
                <section id="key-features">
                    ...
                    <ul className="grid grid-cols-1 md:grid-cols-2 gap-6">
                        ...
                        <FeatureItem icon={<SearchIcon className="w-6 h-6"/>} title="محيط البحث والتحليل اللغوي" description="محرك بحث ذكي وسريع بالكلمات أو بالصوت، مع استكشاف جذور المفردات، وبصمة الفواتح المقطعة، ورحلة الرقم عبر المصحف." />
                        <FeatureItem icon={<BookmarkIcon className="w-6 h-6"/>} title="الدفتر والطباعة والتصدير لـ Word" description="احفظ الآيات، اقتطع النصوص بذكاء، دوّن الفوائد، وصدّر إلى مستندات وورد Word (.doc) أو اطبع بجداول منسقة موفرة للحبر." />
